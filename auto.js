...
const navigateAndSelectProduct=(key)=>{
    if(key === "ArrowDown"){
        ...
        indextoselect +=1;
        const productItemSelectContainer=selectProduct(indextoselect);
...
const selectProduct=(indextoselect)=>{
    const producttoselect=filterproducts[indextoselect].id.toString();
    const productItemSelectContainer=document.getElementById(producttoselect);
...
const deselectProduct=()=>{
    const productDeselect=document.getElementsByClassName("selected")[0]
    productDeselect.style.backgroundColor="white"
    productDeselect.firstChild.style.color="black"
    productDeselect.classList.remove("selected")
}